...
const Elem = [
    {
        dp: "https://images.unsplash.com/photo-1534679949574-9c91880cf453?q=80&w=1371&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        story: "https://images.unsplash.com/photo-1534679949574-9c91880cf453?q=80&w=1371&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
    ...
    },
    {
        ...
        story: "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
    ...
    {
        dp: "https://images.unsplash.com/photo-1516726817505-f5ed825624d8?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
Elem.forEach((val, i) => {
    ...
    <img src="${val.dp}" id = ${i} alt="">
</div>`
})
StoryBox.innerHTML = Clutter;

StoryBox.addEventListener("click", (ele) => {
    if(ele.target.id)
    {
    console.log(ele.target.id);
    ShowStory.style.display = "block"
    ShowStory.style.backgroundImage = `url(${Elem[ele.target.id].story})`
    setTimeout(() => {
